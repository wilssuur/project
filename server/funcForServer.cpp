...
QByteArray parsing(QByteArray str)
{
    ...
    if (mystr == "Auth") {
        ...
        QString answer = task_1(QString::fromStdString(t), QString::fromStdString(e));
...
QString task_1(QString tops, QString edges)
{
    ...
    {
        for (int j = 1; j < s; j++){
            QString ind = QString::number(matrix[i][j]);
            server_result = server_result + ind;}
        server_result = server_result + "/";
    }
    qDebug() << "result " << server_result;
...
void TestTask1() {
    ...
    assert(task_1("4", "(1,2),(1,4),(2,1),(2,4),(2,3),(3,2),(4,1),(4,2)") == QString::fromStdString("0101/1011/0100/1100"));
    assert(task_1("4", "(1,2),(1,4),(2,1),(2,3),(2,4),(3,2),(3,4),(4,1),(4,2),(4,3)") == QString::fromStdString("0101/1011/0101/1110"));
    assert(task_1("4","(1,2),(1,3),(1,4),(2,1),(2,3),(3,2),(3,1),(4,1)") == QString::fromStdString("0111/1010/1100/1000"));
    assert(task_1("6","(1,2),(1,5),(2,1),(2,3),(2,5),(3,2),(3,4),(4,3),(4,5),(4,6),(5,1),(5,2),(5,4),(6,4)") == QString::fromStdString("010010/101010/010100/001011/110100/000100"));
    //assert(task_1("7","(1,3),(1,4),(1,5),(1,7),(2,3),(2,6),(4,5),(6,7)") == QString::fromStdString(""));
...
void TestTask3() {
    ...
    assert(task_3("5", "(1,3),(1,5),(2,4),(2,5),(3,5),(4,5)") == QString::fromStdString("1,5,4,2,5,3,1"));
    assert(task_3("5", "(1,3),(1,5),(2,4),(2,5),(3,5),(4,5)") == QString::fromStdString("1,5,4,2,5,3,1"));
    assert(task_3("5","(1,2),(1,3),(2,3),(3,5),(3,4),(4,5)") == QString::fromStdString("1,3,5,4,3,2,1"));
    assert(task_3("7","(1,3),(1,4),(1,5),(1,7),(2,3),(2,6),(4,5),(6,7)") == QString::fromStdString("1,5,4,1,7,6,2,3,1"));
    assert(task_3("8","(1,2),(1,4),(1,6),(1,8),(2,3),(2,5),(2,7),(3,4),(3,6),(3,8),(4,5),(4,7),(5,6),(5,8),(6,7),(7,8)") == QString::fromStdString("1,8,7,6,5,4,7,2,5,8,3,6,1,4,3,2,1"));
    qDebug() << "TestTask3 OK";
